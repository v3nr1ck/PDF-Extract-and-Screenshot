...
def _search_single_term(doc, search_text, case_sensitive, whole_word, use_regex, page_start, page_end, zoom, padding, max_per_page, extraction_mode='off', extraction_pattern=''):
...
def search_pdf():
    ...
    for search_text in search_terms:
        results, error = _search_single_term(
            ...
            extraction_mode, extraction_pattern
        )
